...
public class CartPageTest extends BaseTest {
    private Cart.CartPage cartPage;
    ...
    public void testCartPageLoads() {
        assertThat(cartPage.getTitleLocator()).hasText("Products");
    }

    @Test(priority = 2)
    public void testAppleMonitorDeleteFromCart() {
    ...
    public void testCartTotalPrice() {
        ...
        assertEquals(actualTotalPrice, getProductPriceSum(),
                "Total price and sum of product prices are not the same");
    }

    @Test(priority = 4)
    public void testPlaceOrderButton() {
        cartPage.clickPlaceOrderButton();
        assertThat(cartPage.getCartPopUpTitleLocator()).hasText("Place order");
    }

    @Test(priority = 5, dataProvider = "purchaseDataProvider")
    public void testPurchaseOrderPlace(String name, String country, String city,
        ...
        assertThat(cartPage.getPurchasePopUpTitleLocator()).hasText("Thank you for your purchase!");
    }

    @Test(priority = 6)
    public void testPopUpPrice() {
        BigDecimal popUpPrice = cartPage.getPopUpPrice();
        assertEquals(popUpPrice, getProductPriceSum(),
                "Order price and actual price are different");
